    ...
    <div className="consent-box">
      ...
      <div className="text-[20px]">
        <div>
          ...
          burns, sprains, fractures, scrapes, bruises and cuts, joint
          dislocations, pinched fingers and serious injuries to head, back or
          neck which can cause paralysis or even death. Participants often fall
          from the equipment, sprain, or break wrist, ankles &amp; legs and can
          suffer more serious injury as well. Participants often fall on each
          other resulting in broken bones and other serious injuries. Double
          ...
          and the equipment being used might malfunction in rare cases. I have
          had sufficient opportunity to read this document.:
        </div>
        <div>
          i) I have read and understood and agree to be bound by its terms.
        </div>
        <div>
          ii) I am at least 18 years old and I have read and agree to the terms
          of the above agreement.
        </div>
        <div>
          iii) I certify that I am the parent or legal guardian of the above
          child and confirm that the information I entered is accurate and true.
        </div>

        <div className="italic my-3 font-semibold">
          I HEREBY WAIVE, RELEASE AND DISCHARGE COSMIC EXIM &amp; WILL NOT ASK
          FOR INDEMNIFICATION MUCH LESS SUE:
        </div>
        <div>
          its owners, partners, officers, employees, volunteers,
          representatives, and agents, and the activity holders, sponsors from
          any and all forms of liability for my (or my child&apos;s) death,
          accident, disability, personal injury, property damage, property
          theft, loss, or actions of any kind which may hereafter occur to me
          (or my child) including my traveling to and from this activity.
        </div>

        <div>
          I agree that in case of any accident or mishappening, I shall not post
          disparaging or defamatory statements about the company or its business
